...
const qualityPoints = [
  {
    ...
    description: "MAZARIN CONDUITE & FORMATION est une auto-école agréée par la Préfecture, garantissant le respect des normes d'enseignement et de sécurité.",
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 animate-fade-in-up">
        <SectionTitle
          ...
          subtitle="Chez MAZARIN CONDUITE & FORMATION, nous sommes fiers de nos engagements pour vous offrir la meilleure formation possible."
          centered
        />
